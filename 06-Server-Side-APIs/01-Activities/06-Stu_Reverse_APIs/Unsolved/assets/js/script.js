...
// the response is returned with reloading the page
$.ajax({
  url: requestUrl,
  method: 'GET',
...
// fetch the call is fullfilled in the future - a promise 
fetch(requestUrl)
  .then(function (response) {
...
// It is returned with the readyState is DONE
...
// the json data has to be parsed
