...
// event triggers on a child, event listener is applied on the parent oand some functionality is implemented 
// Delegate event listener to the parent element, <div id="buttons">
// The event listener is triggered for every child class .letter-button for the parent element buttonListEl or for element with id "button"
